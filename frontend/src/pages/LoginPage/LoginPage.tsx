...
function handleEmail(e:any){
   ...
   async  function login(){
        ...
        let res=await post('http://localhost:8060/auth/login',{email:"anes@gmail.com",password:"12345678"})
          if(res.status==200){
    ...
    <div id={styles.container}>
        <div id={styles.loginContainer}>
            <nav id={styles.mainNav}>
                ...
                <Link to="/register" id={styles.register} className={styles.authBtn}>Register</Link>
                ...
                <section id={styles.loginSection}>
                    ...
                    <form id={styles.loginForm}>
                        ...
                        <div id={styles.loginControls}>
                            ...
                            <button  className={styles.authBtn} type='button' id={styles.loginBtn} onClick={login}>Login</button>
                        </div>
