...
fd.append('date',formateDateToLocal(startDate,minute,hour));
console.log(fd)
if(materials.length){
materials.forEach((m)=>{
...
axios.post('http://localhost:8060/classroom',fd)
  ...
  return (
    <div id='classroom-container'>
      <form id='classroom-adder-form' ref={adderForm}>
        ...
        <div className='spanner' style={{ width:"80%", textAlign:"center",alignSelf:"self-start"}}>
        <label htmlFor='title'>Classroom Title</label>
        <input style={{width:"70%",maxWidth:"25em" ,marginLeft:"2em",border:"0.02em solid black",borderRadius:"5em",marginTop:"1em", height:"2em",textAlign:"center" ,marginBottom:"2em"}} type='text' required onChange={handleTitle} value={title} />
        </div>
        <div className='spanner' style={{ width:"80%", textAlign:"center",alignSelf:"self-start"}}>
        ...
        <textarea  id='classroom-description' style={{width:"70%",maxWidth:"25em",maxHeight:"5em" ,height:"5em",textAlign:"center"}} required onChange={handleDescription} value={description} />
        ...
        </div><div className='spanner' id='visibility-container'>
          ...
          <span id='password-container' ref={passwordContainer} className='column'>
            ...
            <input ref={passwordInput} type='password'  name='password' style={{border:"0.08em solid black",borderRadius:"1em"}} required onChange={handlePassword} value={password} />
          ...
          <div className='spanner' style={{marginTop:"2em",maxWidth:"45em",justifyContent:"flex-start",overflow:"scroll"}}>
            <div className='column' >
          ...
          <button id='add-classroom-btn' type='button' onClick={addClassroom}>Add Classroom</button>
